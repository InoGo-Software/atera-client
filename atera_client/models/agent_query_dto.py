...
class AgentQueryDTO(object):
    ...
    def __init__(self, machine_id=None, agent_id=None, device_guid=None, folder_id=None, customer_id=None, customer_name=None, agent_name=None, system_name=None, machine_name=None, domain_name=None, current_logged_users=None, computer_description=None, monitored=None, last_patch_management_received=None, agent_version=None, favorite=None, threshold_id=None, monitored_agent_id=None, created=None, modified=None, online=None, reported_from_ip=None, app_view_url=None, motherboard=None, processor=None, memory=None, display=None, sound=None, processor_cores_count=None, system_drive=None, processor_clock=None, vendor=None, vendor_serial_number=None, vendor_brand_model=None, product_name=None, mac_addresses=None, ip_addresses=None, hardware_disks=None, os=None, os_type=None, windows_serial_number=None, office=None, office_sp=None, office_oem=None, office_serial_number=None, os_num=None, last_reboot_time=None, os_version=None, os_build=None, office_full_version=None, last_login_user=None, _configuration=None):  # noqa: E501
